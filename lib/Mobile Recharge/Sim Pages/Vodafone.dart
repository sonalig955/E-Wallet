...
class VodafonePage extends StatefulWidget {
  const VodafonePage({Key? key}) : super(key: key);
...
class _VodafonePageState extends State<VodafonePage> {
  final List<String> _animals = <String>['₹99/200MB/28Days','₹107/200MB/30Days', '₹111/200MB/31Days','₹418/100GB/56Days','₹118/12GB/28Days'];
  String dropdownValue = '₹99/200MB/28Days';
